...
var _mintUi = __webpack_require__(37);
...
_vue2.default.filter('transformPrice', function (value) {
    if (value >= 0) {
        return parseFloat(value).toFixed(2);
    }
});

_vue2.default.filter('rnTransform', function (value) {
    if (value) {
        return value.replace(/\r\n/g, "<br/>");
    }
});

_vue2.default.directive('data-scroll', function (value) {
...
_vue2.default.filter('transformPhone', function (value) {
    if (value) {
        var phone = value;
        var phone_head = phone.substring(0, 3);
        var phone_foot = phone.substr(7, 4);
...
_axios2.default.defaults.headers.common['X-CSRF-TOKEN'] = document.querySelector('#csrf-token').getAttribute('content');
...
exports.default = {
    ...
    methods: {
        fetchUser: function fetchUser() {
            ...
            var shopConfig = localStorage.getItem("shopConfig");
            if (userInfo) {
                vm.$set("user", JSON.parse(userInfo));
            } else {
                vm.$http.get("/api/userinfo").then(function (response) {
                    vm.$set("user", response.data);
                    localStorage.setItem("userInfo", (0, _stringify2.default)(response.data));
                });
            }
            if (!shopConfig) {
                vm.$http.get("/api/shopconfig").then(function (response) {
                    localStorage.setItem("shopConfig", (0, _stringify2.default)(response.data));
                });
            }
        }
    }
...
Component.options.__file = "resources/assets/js/components/_layouts/Navbar.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5e83a14e", Component.options)
  } else {
    hotAPI.reload("data-v-5e83a14e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
exports.default = {
  ...
  methods: {
    ...
    initCartCount: function initCartCount() {
    ...
    routeHandler: function routeHandler(val) {
      var routerList = ["home", "category", "cart", "usercenter"];
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "app-tab--bar" },
    [
      _c("div", { attrs: { id: "nav-hot-fix" } }),
      _vm._v(" "),
      _c(
        "mt-tabbar",
        {
        ...
        [
          ...
          _vm._v(" "),
          _c("mt-tab-item", { attrs: { id: "category" } }, [
            _c("i", {
          ...
          _vm._v(" "),
          _c("mt-tab-item", { attrs: { id: "cart" } }, [
            _c(
              "i",
              {
                staticClass: "nav-cart",
                attrs: { slot: "icon" },
                slot: "icon"
              },
              [
          ...
          _vm._v(" "),
          _c("mt-tab-item", { attrs: { id: "profile" } }, [
            _c("i", {
              staticClass: "nav-usercenter",
              attrs: { slot: "icon" },
              slot: "icon"
            }),
            _vm._v("\n        账户中心\n    ")
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5e83a14e", module.exports)
  }
}
...
var AppRouter = exports.AppRouter = new _vueRouter2.default({
    base: '/',
    mode: 'hash',
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1bef400e", Component.options)
  } else {
    hotAPI.reload("data-v-1bef400e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var _topic = __webpack_require__(58);

var _topic2 = _interopRequireDefault(_topic);

var _plate = __webpack_require__(63);

var _plate2 = _interopRequireDefault(_plate);

var _goods = __webpack_require__(68);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1b57efee", Component.options)
  } else {
    hotAPI.reload("data-v-1b57efee", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(3)("0dfb397b", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1b57efee\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./carousel.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1b57efee\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./carousel.vue");
...
exports.default = {
  ...
  methods: {
    fetchBanner: function fetchBanner() {
      ...
      this.$http.get("/api/banners").then(function (resp) {
        return resp.data;
      }).then(function (data) {
        _this.banners = data;
      });
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1b57efee", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/home/topic.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-39508dd6", Component.options)
  } else {
    hotAPI.reload("data-v-39508dd6", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("5c88ef9f", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-39508dd6\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./topic.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-39508dd6\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./topic.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports.default = {
  ...
  methods: {
    fetchTopic: function fetchTopic() {
      ...
      this.$http.get("/api/topics").then(function (resp) {
        return resp.data;
      }).then(function (data) {
  ...
  return _c(
    ...
    _vm._l(_vm.topics, function(topic) {
      return _c(
        ...
        {
          key: topic.id,
          attrs: { href: "/topic/{topic.id}", id: "topic.topic_title" }
        },
        [
          _c("img", {
            staticClass: "topic-icon",
            attrs: { slot: "icon", src: topic.topic_img },
            slot: "icon"
          }),
          _vm._v("\n      " + _vm._s(topic.topic_title) + "\n  ")
        ]
      )
    })
  )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-39508dd6", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/home/plate.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ac015f86", Component.options)
  } else {
    hotAPI.reload("data-v-ac015f86", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("60cfc7c5", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ac015f86\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./plate.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ac015f86\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./plate.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports.default = {
  ...
  methods: {
    fetchPlates: function fetchPlates() {
      ...
      this.$http.get("/api/plates").then(function (resp) {
        return resp.data;
      }).then(function (data) {
        return _this.plates = data;
      }).catch(console.error);
    }
  }
};
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "plate-wrapper" }, [
    _c(
      "div",
      { staticClass: "pure-g" },
      _vm._l(_vm.plates, function(plate) {
        return _c(
          "div",
          { key: plate.id, staticClass: "pure-u-1-2 plate-card" },
          [
            _c("a", { attrs: { href: "/plate/{plage.id}" } }, [
              _c("img", {
                staticClass: "plate-img",
                attrs: { src: plate.plate_img }
              }),
              _vm._v(" "),
              _c("p", { staticClass: "plate-title" }, [
                _vm._v(
                  "\n            " + _vm._s(plate.plate_title) + "\n          "
                )
              ])
            ])
          ]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-ac015f86", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/home/goods.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7549ec7d", Component.options)
  } else {
    hotAPI.reload("data-v-7549ec7d", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("2807fa29", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7549ec7d\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./goods.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7549ec7d\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./goods.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports.default = {
  ...
  created: function created() {
    this.$http.get("/api/goods").then(function (resp) {
      return resp.data;
    }).then(this.updateData).catch(console.error);
  }
};
...
var render = function() {
  ...
  return _c(
    ...
    [
      _vm.loading
        ? _c("mt-spinner", { attrs: { type: "triple-bounce" } })
        : _vm._e(),
      _vm._v(" "),
      !_vm.loading
        ? _c(
            ...
            _vm._l(_vm.goodsList, function(goods) {
              return _c(
                "div",
                { key: goods.id, staticClass: "pure-u-1-2 card-goods" },
                [
                  _c("img", {
                    staticClass: "goods-thumbnail",
                    attrs: { src: goods.commodity_img }
                  }),
                  _vm._v(" "),
                  _c("p", { staticClass: "goods-title" }, [
                    _vm._v(_vm._s(goods.commodity_name))
                  ])
                ]
              )
            })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7549ec7d", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("mt-header", { attrs: { title: "long long long long title" } }),
      _vm._v(" "),
      _c("carousel"),
      _vm._v(" "),
      _c("topic"),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1bef400e", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/category/index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-24de55d8", Component.options)
  } else {
    hotAPI.reload("data-v-24de55d8", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
exports.default = {
  ...
  methods: {
    fetchCategories: function fetchCategories() {
      ...
      this.$http.get("/api/categories").then(function (resp) {
        return resp.data;
      }).then(function (data) {
        return _this.categories = data;
      }).then(this.showSubCategories).catch(console.error);
    },

    showSubCategories: function showSubCategories(c) {
      var showCate = c;
      if (!c) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "page-category" }, [
    _c("div", { attrs: { id: "categories-content-left" } }, [
      _c(
        "ul",
        _vm._l(_vm.categories, function(category) {
          return _c(
            "li",
            {
              key: category.id,
              class: {
                active: _vm.activeCategory == category.parent_category.id
              },
              on: {
                click: function($event) {
                  _vm.showSubCategories(category)
                }
              }
            },
            [
              _c("span", [
                _vm._v(_vm._s(category.parent_category.category_name))
              ])
            ]
          )
        })
    ...
    _vm._v(" "),
    _c("div", { attrs: { id: "categories-content-right" } }, [
      _c(
        "ul",
        _vm._l(_vm.subCategories, function(sub_category) {
          return _c(
            "li",
            {
              directives: [
                {
                  ...
                  value: {
                    name: "aCategory",
                    params: { hashid: sub_category.id }
                  },
                  expression:
                    "{name:'aCategory',params:{'hashid':sub_category.id}}"
                }
              ],
              key: sub_category.id
            },
            [
              _c("img", { attrs: { src: sub_category.category_img } }),
              _vm._v(" "),
              _c("h4", [_vm._v(_vm._s(sub_category.category_name))])
            ]
          )
        })
      )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-24de55d8", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    [_c("router-view"), _vm._v(" "), _c("Navbar")],
    1
  )
}
var staticRenderFns = []
